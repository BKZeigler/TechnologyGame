...
public class TechnologyTest : MonoBehaviour
{
    ...
    //contrsuctor to create a technology with given parameters
    public TechnologyTest(Dictionary<int, float> statDictionary, Dictionary<int, Ability> abilityDictionary, Dictionary<int, Passive> passiveDictionary)
    {
